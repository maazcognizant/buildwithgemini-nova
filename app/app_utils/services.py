...
def get_memory_service():
    """Process-wide memory service: VertexAiMemoryBankService when MEMORY_BANK_ID is set, else in-memory."""
    if memory_bank_id := os.environ.get("MEMORY_BANK_ID", "3741826635565891584"):
        from google.adk.memory import VertexAiMemoryBankService

        project = os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-03-2f074985a624")
